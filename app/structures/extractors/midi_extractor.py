...
class MidiExtractor:
    ...
    def load_midi_segment(
        ...
        try:
            ...
            for track in mid.tracks:
                ...
                features = self._analyze_midi_features(
                    segment_events, start_time, end_time
                )
                ...
                features["event_summary"] = {
                    ...
                    "channels_used": list(
                        set(e["channel"] for e in segment_events if "channel" in e)
                    ),
                }
    ...
    def _analyze_midi_features(
        ...
        features = {
            ...
            "note_density": (
                len(note_on_events) / (end_time - start_time)
        ...
        if note_on_events:
            ...
            if len(onset_times) > 1:
                ...
                features["rhythmic_regularity"] = (
                    1 / (1 + np.var(intervals)) if len(intervals) > 0 else 0
                )

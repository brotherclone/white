...
class TestReadPhaseStatuses:
    def test_reads_all_phases(self, tmp_path):
        from white_composition.pipeline_runner import read_phase_statuses
...
class TestCmdStatus:
    def test_prints_phase_names(self, tmp_path, capsys):
        from white_composition.pipeline_runner import cmd_status
...
class TestCmdRun:
    def test_runs_next_phase_and_updates_status(self, tmp_path):
        ...
        with patch("white_composition.pipeline_runner.subprocess.run") as mock_run:
    ...
    def test_returns_0_when_nothing_to_run(self, tmp_path):
        from white_composition.pipeline_runner import cmd_run
...
class TestPromotePartStatusSync:
    def test_promote_writes_promoted_status(self, tmp_path):
        from white_composition.promote_part import _sync_promote_status
...
class TestCmdBatch:
    def test_batch_finds_pending_dirs(self, tmp_path):
        from white_composition.pipeline_runner import cmd_batch

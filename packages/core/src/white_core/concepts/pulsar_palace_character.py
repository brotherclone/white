...
from white_core.artifacts.character_portrait_artifact import (
    CharacterPortraitArtifact,
)
from white_core.artifacts.image_artifact_file import ImageChainArtifactFile
from white_core.enums.chain_artifact_file_type import ChainArtifactFileType
from white_core.util.gaming_tools import no_repeat_roll_dice, roll_dice
from white_core.util.image_tools import composite_character_portrait

...
from white_core.util.infranym.infranym_audio_encoder import InfranymAudioEncoder
...
class InfranymAudioArtifact(AudioChainArtifactFile, ABC):
    ...
    # Override audio_bytes as optional - we generate audio via encoder instead
    audio_bytes: bytes = Field(
        default=b"", description="Audio bytes (generated by encoder)"
    )

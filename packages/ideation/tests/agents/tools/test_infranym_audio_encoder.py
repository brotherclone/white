...
from white_ideation.agents.tools.infranym_audio_encoder import InfranymAudioEncoder
...
def encoder(temp_output_dir, mock_tts_engine):
    ...
    with patch(
        "white_ideation.agents.tools.infranym_audio_encoder.pyttsx3.init",
...
class TestApplyVoiceProfile:
    ...
    def test_apply_robotic_profile(self, mock_audio_segment):
        ...
        with patch(
            "white_ideation.agents.tools.infranym_audio_encoder.high_pass_filter",
    ...
    def test_apply_whisper_profile(self, mock_audio_segment):
        ...
        with patch(
            "white_ideation.agents.tools.infranym_audio_encoder.low_pass_filter",
            return_value=mock_audio_segment,
        ):
            result = InfranymAudioEncoder.apply_voice_profile(

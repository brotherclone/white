...
def test_discogs_mcp():
    ...
    from white_ideation.reference.mcp.discogs.main import mcp
...
async def test_discogs_look_up_artist_by_name():
    ...
    from white_ideation.reference.mcp.discogs.main import look_up_artist_by_name

    # Mock the discogs client
    with patch(
        "white_ideation.reference.mcp.discogs.main.discogs_earthly_frames_retriever_service"
    ) as mock_service:

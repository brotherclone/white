...
def test_lucid_nonsense_access_mcp():
    ...
    from white_ideation.reference.mcp.lucid_nonsense_access.main import mcp
...
def test_get_base_path():
    ...
    from white_ideation.reference.mcp.lucid_nonsense_access.main import get_base_path
...
def test_search_white_project_files():
    ...
    from white_ideation.reference.mcp.lucid_nonsense_access.main import (
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch(
            "white_ideation.reference.mcp.lucid_nonsense_access.main.get_base_path"
        ) as mock_path:

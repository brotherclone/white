...
def test_todoist_mcp():
    ...
    from white_ideation.reference.mcp.todoist.main import mcp
...
def test_get_api_client():
    ...
    from white_ideation.reference.mcp.todoist.main import get_api_client

    with patch.dict("os.environ", {"TODOIST_API_TOKEN": "test_token"}):
        with patch("white_ideation.reference.mcp.todoist.main.TodoistAPI") as mock_api:
...
def test_get_api_client_no_token():
    ...
    # Reset the singleton
    import white_ideation.reference.mcp.todoist.main as todoist_main
    from white_ideation.reference.mcp.todoist.main import get_api_client
...
def test_get_earthly_frames_project_sections():
    ...
    from white_ideation.reference.mcp.todoist.main import (
    ...
    with patch(
        "white_ideation.reference.mcp.todoist.main.get_api_client"
    ) as mock_get_client:
        mock_api = MagicMock()

...
def test_mcp_midi_mate():
    ...
    from white_ideation.reference.mcp.midi_mate.main import mcp
...
def test_save_midi_from_base64_basic():
    ...
    from white_ideation.reference.mcp.midi_mate.main import save_midi_from_base64
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        with patch("white_ideation.reference.mcp.midi_mate.main.MidiFile") as mock_midi:

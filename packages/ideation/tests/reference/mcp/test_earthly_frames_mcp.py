...
def test_earthly_frames_mcp():
    ...
    from white_ideation.reference.mcp.earthly_frames.main import mcp
...
async def test_get_all_recordings():
    ...
    from white_ideation.reference.mcp.earthly_frames.main import get_all_recordings
    ...
    with patch(
        "white_ideation.reference.mcp.earthly_frames.main.earthly_frames_retriever_service",
...
async def test_album_for_color():
    ...
    from white_ideation.reference.mcp.earthly_frames.main import album_for_color

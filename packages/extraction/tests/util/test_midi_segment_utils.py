...
import pytest
from white_extraction.util import midi_segment_utils
...
class TestWithMido:
    ...
    @patch("white_extraction.util.midi_segment_utils.MidiFile")
    ...
    def test_segment_midi_with_audio_no_manifest(self, tmp_path):
        ...
        with patch(
            "white_extraction.util.midi_segment_utils.segment_midi_file"
        ) as mock_segment:

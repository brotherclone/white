...
from white_extraction.util.timestamp_pipeline import (
    PipelineConfig,
    SegmentMetadata,
...
class TestProcessTrackDirectory:
    ...
    @patch("white_extraction.util.timestamp_pipeline.load_manifest")
    ...
    @patch("white_extraction.util.timestamp_pipeline.load_manifest")
    @patch("white_extraction.util.timestamp_pipeline.create_segment_specs_from_lrc")
...
class TestProcessMultipleTracks:
    ...
    @patch("white_extraction.util.timestamp_pipeline.process_track_directory")
    ...
    def test_process_multiple_tracks_default_config(self, tmp_path):
        ...
        with patch(
            "white_extraction.util.timestamp_pipeline.process_track_directory"
        ) as mock_process:
...
class TestProcessStagedRawMaterial:
    ...
    @patch("white_extraction.util.timestamp_pipeline.process_multiple_tracks")

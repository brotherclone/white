...
class TestBassPatternTemplates:
    ...
    def test_all_templates_have_valid_velocity_levels(self):
        from app.generators.midi.patterns.bass_patterns import ALL_TEMPLATES, VELOCITY
...
class TestToneResolution:
    ...
    def test_clamp_to_bass_register_high_note(self):
        from app.generators.midi.patterns.bass_patterns import clamp_to_bass_register
    ...
    def test_extract_root_from_voicing(self):
        from app.generators.midi.patterns.bass_patterns import extract_root
    ...
    def test_extract_chord_tones_c_major(self):
        from app.generators.midi.patterns.bass_patterns import extract_chord_tones
    ...
    def test_resolve_tone_root(self):
        from app.generators.midi.patterns.bass_patterns import resolve_tone
...
class TestTemplateSelection:
    ...
    def test_fallback_pattern(self):
        from app.generators.midi.patterns.bass_patterns import make_fallback_pattern
...
class TestTheoryScoring:
    ...
    def test_root_adherence_all_root(self):
        from app.generators.midi.patterns.bass_patterns import root_adherence
    ...
    def test_kick_alignment_perfect(self):
        from app.generators.midi.patterns.bass_patterns import kick_alignment
    ...
    def test_voice_leading_score_unison(self):
        from app.generators.midi.patterns.bass_patterns import voice_leading_score
    ...
    def test_bass_theory_score_with_kick(self):
        from app.generators.midi.patterns.bass_patterns import bass_theory_score

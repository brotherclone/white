...
EXPECTED = {"HIGH": "high", "MEDIUM": "medium", "LOW": "low", "MINIMAL": "minimal"}
...
def test_lookup_by_name():
    ...
    assert BiographicalTimelineDetailLevel["LOW"] is BiographicalTimelineDetailLevel.LOW


def test_invalid_value_raises_value_error():
    with pytest.raises(ValueError):
        BiographicalTimelineDetailLevel("Unknown")
...
def test_enum_members_are_enum_instances():
    assert isinstance(BiographicalTimelineDetailLevel.MEDIUM, enum.Enum)

# Spec: prism-auto-chord-generation

Extends The Prism (`WhiteAgent`) to optionally invoke the chord generation pipeline
immediately after `finalize_song_proposal` completes.

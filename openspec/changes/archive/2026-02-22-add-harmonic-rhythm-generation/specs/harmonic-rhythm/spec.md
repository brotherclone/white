...
Generate variable chord duration distributions for song sections, aligning chord changes with drum accents and scoring against ChromaticScorer temporal mode.

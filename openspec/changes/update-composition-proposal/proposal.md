...
`repeat=1`. It is a mechanical inventory, not a compositional act. The drift report
...
- `refresh_plan()` preserves human edits to `repeat`, `reason`, and section order while

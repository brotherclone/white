# Facet Evolution - COMPARATIVE

**Initial Refraction Angle**: chromatic aberration
...
### ORANGE Agent
- Refraction Angle: ontological dispersion
- Boundaries Shifted:
...
### YELLOW Agent
- Refraction Angle: double refraction
- Boundaries Shifted:
  - From PAST to FUTURE
  - From THING to PLACE
...
### VIOLET Agent
- Refraction Angle: chromatic aberration
- Boundaries Shifted:
